// Generated from Python.g4 by ANTLR 4.9.1
// jshint ignore: start
	...
	prog() {
	    ...
	    try {
	        ...
	        do {
	            ...
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	        } while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << PythonParser.T__1) | (1 << PythonParser.ID) | (1 << PythonParser.INT) | (1 << PythonParser.NEWLINE))) !== 0));
	    } catch (re) {
	        ...
	        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
	            if(_alt===1) {
	                ...
	                case 1:
	                    ...
	                    _la = this._input.LA(1);
	                    if(!(_la===PythonParser.MUL || _la===PythonParser.DIV)) {
	                ...
	                case 2:
	                    ...
	                    localctx.op = this._input.LT(1);
	                    _la = this._input.LA(1);
	                    if(!(_la===PythonParser.ADD || _la===PythonParser.SUB)) {
	                        localctx.op = this._errHandler.recoverInline(this);
	                    }
	                    else {
	                    	this._errHandler.reportMatch(this);
